...
function f7() {
    ...
    out1.innerHTML = inp;
    out2.innerHTML = inp.length >= 6 ? '1' : '0';
...
function f14() {
    ...
    let texta = document.querySelector('.t-14');
    out.innerHTML = texta.value
}
...
function f15() {
    ...
    let texta = document.querySelector('.t-15');
    let inp = document.querySelector('.i-15');
    out.innerHTML = inp.value
    texta.innerHTML = inp.value
}
